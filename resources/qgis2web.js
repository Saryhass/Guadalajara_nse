...
map.getView().fit([-11556123.182926, 2311935.669979, -11454274.637622, 2391383.047187], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Niveles socioeconomicos en guadalajara</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (47 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ELABORACION DE SARY HASSAN. FUENTE: SCINCE 2020';
            }
